...
- Media blocks: photo, video, animation, audio, voice – all with optional spoiler, caption and credit (`<figure>`/`<figcaption>`/``                                                          |                                                                                          |  
| `mathBlock(latex)`                 | `<tg-math-block>…</tg-math-block>`                               |                                                                                          |  
| `anchor(name)`                     | `<a name="…"></a>`                                               | standalone anchor                                                                        |  
| `blockquote(content, credit?)`     | `<blockquote>…</blockquote>`                       | content can be inline or block                                                           |  
| `pullquote(text, credit?)`         | `<aside>…</aside>`                                 |                                                                                          |  
...
> ⭐ Like this tool? Give it a star on GitHub – it helps others discover the project!